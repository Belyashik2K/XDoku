...
int main() {
    ...
    //
    // auto sudokuGameSummaryView = std::make_unique<ImguiSudokuGameSummaryView>();
    // const auto sudokuGameSummaryPresenter = std::make_shared<SudokuGameSummaryPresenter>(
    //     eventBus, sudokuGameManager
    // );
    // sudokuGameSummaryPresenter->init(std::move(sudokuGameSummaryView));
    ...
    // appMediator->setSudokuGameSummaryPresenter(sudokuGameSummaryPresenter);

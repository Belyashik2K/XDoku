...
class PostgreSQLDatabase final : public IDatabase<pqxx::params, pqxx::result> {
...
public:
    ...
    pqxx::result execute(IQuery<pqxx::params> &query) override;
};
